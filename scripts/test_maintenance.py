...
class MaintenanceTest(TestCase):
  def test_regex_sub(self):
    filename = '/Users/ykoh/WebstormProjects/english.advenoh.pe.kr/src/content/spring/스프링부트-기본-오류-페이지-변경하기.md'
    ...
    self.assertEqual(result, 'https://english.advenoh.pe.kr/spring/스프링부트-기본-오류-페이지-변경하기')
